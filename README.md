...
- **Gateway (Primary):** VPS (VPS Provider IP: `x.x.x.x`) acts as the public ingress point.
- **Gateway (Secondary / EU Peering):** Additional VPS (Germany) used for peering / faster EU access (separate WireGuard peer).
- **Tunnel:** WireGuard Site-to-Site (`10.0.0.x`) establishes a persistent, encrypted link between the cloud VPS(s) and the home server (multi-peer).
...
- [OK] `/source/etc` (System Configs, Firewall Rules, WireGuard Keys, Fstab)
- [OK] `/source/DATA/AppData` (Docker Container Configs, Databases)
- [OK] `/source/home/user` (User Scripts, Shell History)
- [OK] `/source/mnt/sdd2/music` (FLAC Media Library)
...
| :---------------- | :-------------------- | :------ | :------------------------------------------------- |
| **Homepage**      | `example.com` | `3067`  | Central command dashboard for monitoring services. |
...
- [OK] `/source/etc` (System Configs, Firewall Rules, WireGuard Keys, Fstab)
- [OK] `/source/DATA/AppData` (Docker Container Configs, Databases, Volumes)
- [OK] `/source/home/user` (User Scripts, Shell History)
- [OK] `/source/var/lib/casaos` (Dashboard Layout & Settings)
- [OK] `/source/var/lib/tailscale` (VPN Identity State)
- [OK] `/source/mnt/sdd2/music` (FLAC Media Library)
